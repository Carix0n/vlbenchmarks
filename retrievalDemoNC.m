function [mAP queriesAp] = retrievalDemoNC(resultsPath)
% RETRIEVALDEMONC Demonstrates how to run the retrieval benchmark
%   RETRIEVALDEMONC() Runs the repeatability demo.
%
%   RETRIEVALDEMONC(RESULTS_PATH) Run the demo and save the results to
%   path RESULTS_PATH.
...
featExtractors{4} = NeuralCodesFeatureExtractor('levels', 1:4, ...
...
detNames = {'VLF-heslap', 'VLF-harlap', 'VLF-SIFT', 'NeuralCodes'};
